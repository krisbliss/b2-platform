...
GL9_FLAG_LIKELY_AI_GENERATED = "LIKELY_AI_GENERATED"

# Threshold above which the SynthID check emits LIKELY_AI_GENERATED.
# Chosen as a conservative midpoint: scores >= 0.6 indicate strong watermark
# or synthetic signal from the detector.
SYNTHID_AI_GENERATED_THRESHOLD = 0.6
